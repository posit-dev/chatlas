...
class TestToolFromMCP:
    ...
    async def test_mcp_tool_call_text_result(self):
        ...
        results = []
        async for result in tool.func(message="Hello"):
    ...
    async def test_mcp_tool_call_resource_result_text(self):
        ...
        # Mock text resource
        mock_resource = TextResourceContents(text="File contents here")
    ...
    async def test_mcp_tool_call_error(self):
        ...
        with pytest.raises(RuntimeError, match="Error executing tool error_tool: Something went wrong"):
            async for result in tool.func():
                pass
    ...
    async def test_mcp_tool_call_unsupported_image_type(self):
        ...
        with pytest.raises(ValueError, match="Unsupported image MIME type: image/unsupported"):
            async for result in tool.func():
                pass
    ...
    def test_mcp_tool_input_schema_conversion(self):
        ...
        assert "title" not in tool.schema["function"]["parameters"]["properties"]["param"]