...
from ._provider_openai import load_tool_request_args
from ._provider_openai_generic import BatchResult, GenericOpenAIProvider
...
if TYPE_CHECKING:
    ...
    from .types.openai import ChatClientArgs, ResponsesSubmitInputArgs

Role = Literal["user", "assistant", "system"]


def ChatOpenAIResponses(
    *,
    ...
    like image generation and web search, or if you want to access reasoning
    models (like the o-series models) that expose their thinking process.
    ...
    chat = ChatOpenAIResponses(api_key=os.getenv("OPENAI_API_KEY"))
    ...
    Pasting an API key into a chat constructor (e.g., `ChatOpenAIResponses(api_key="...")`)
...
class OpenAIResponsesProvider(
    ...
    def chat_perform(
        ...
        *,
        ...
        kwargs: Optional["ResponsesSubmitInputArgs"] = None,
    ):
    ...
    def _chat_perform_args(
        ...
        kwargs_full: "ResponsesSubmitInputArgs" = {
            "stream": stream,
