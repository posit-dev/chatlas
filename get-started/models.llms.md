...
| Databricks | [`ChatDatabricks()`](../reference/ChatDatabricks.llms.md) | ✅ |
| Snowflake Cortex | [`ChatSnowflake()`](../reference/ChatSnowflake.llms.md) | ✅ |
| Mistral | [`ChatMistral()`](../reference/ChatMistral.llms.md) | ✅ |
| Groq | [`ChatGroq()`](../reference/ChatGroq.llms.md) |  |
...
If you’re using `chatlas` inside your organisation, you’ll be limited to what your org allows, which is likely to be one provided by a big cloud provider (e.g. `ChatAzureOpenAI()` or `ChatBedrock()`). If you’re using `chatlas` for your own personal exploration, you have a lot more freedom so we have a few recommendations to help you get started:
...
[![Screenshot of model autocompletion](../images/model-type-hints.png)](../images/model-type-hints.png "Screenshot of model autocompletion")
...
[`ChatAuto()`](../reference/ChatAuto.llms.md) provides access to any provider/model combination through one simple string. This makes for a nice interactive/prototyping experience, where you can quickly switch between different models and providers, and leverage `chatlas`’ smart defaults:
