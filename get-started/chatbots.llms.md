...
Here you’ll learn how to build the most common type of LLM application: a chatbot. There’s a surprising amount of value in a chatbot that simply has a custom [system prompt](../get-started/system-prompt.llms.md) with instructions and useful knowledge (e.g., proprietary documents, data schemas, etc). Adding [tools](../get-started/tools.llms.md) as well can lead to even more compelling user experiences like [querychat](https://github.com/posit-dev/querychat) and [sidebot](https://github.com/jcheng5/py-sidebot).

Chatbots are also a great use-case for chatlas since it makes multi-turn conversations trivial to implement. Various web frameworks like [Shiny](https://shiny.posit.co/), [Streamlit](https://streamlit.io/), Gradio, etc., provide a chat interface that you can combine with chatlas on the backend. You can even combine chatlas with something like [textualize](https://textualize.io) to create a fancy terminal-based chatbot.

## Web-based

### Shiny

[Shiny](https://shiny.posit.co/py/) is a great option for building a chatbot with chatlas. To get a basic [Shiny chatbot](https://shiny.posit.co/py/docs/genai-chatbots.html), pass a chatlas [stream](../get-started/stream.llms.md) to the `.append_message_stream()` method. Some reasons to use Shiny include:
...
[![Screenshot of a Shiny chatbot.](../images/chatbot-shiny.png)](../images/chatbot-shiny.png "Screenshot of a Shiny chatbot.")

Screenshot of a Shiny chatbot.

### Gradio

[Gradio](https://www.gradio.app/) is another option for building a chatbot with chatlas. To get a basic [Gradio chatbot](https://www.gradio.app/guides/creating-a-chatbot-fast), pass a generator function to the `gr.ChatInterface` component’s `fn` argument, and make sure the generator yields the entire response as it is [streamed](../get-started/stream.llms.md).
...
[![Screenshot of a gradio chatbot.](../images/chatbot-gradio.png)](../images/chatbot-gradio.png "Screenshot of a gradio chatbot.")
...
[![Screenshot of a streamlit chatbot.](../images/chatbot-streamlit.png)](../images/chatbot-streamlit.png "Screenshot of a streamlit chatbot.")
...
chatlas itself does, in a sense, already comes with a terminal-based “chatbot” through the [`.chat()` method](../get-started/chat.llms.md). However, if you want to build a more fully featured terminal-based chatbot with things like hyperlinks, proper scrolling, etc., [Textual](https://textual.textualize.io/) would be a great option for doing so.
...
[![Screenshot of a textual chatbot.](../images/chatbot-textual.png)](../images/chatbot-textual.png "Screenshot of a textual chatbot.")
