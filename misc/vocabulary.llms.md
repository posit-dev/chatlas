...
Writing a good prompt is key to effective use of LLMs. For some tips on writing a good system prompt, see the [System Prompt](../get-started/system-prompt.llms.md) page.
