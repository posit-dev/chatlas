...
Writing a good prompt, which is called __prompt design__, is key to effective use of LLMs. It is discussed in more detail in  the [prompt design article](prompts/design.qmd).