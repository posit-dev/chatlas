...
The simplest way to see chatlas spans is to print them to the console. Install the optional OTel dependency and the SDK:

```bash
pip install "chatlas[otel]" opentelemetry-sdk
```
...
```bash
pip install "chatlas[otel]" logfire
logfire auth
```
