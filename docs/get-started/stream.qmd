...
This makes it a better choice than [`.chat()`](../reference/Chat.qmd#chat) for programming bespoke experiences such as [chatbot](chatbot-apps.qmd) apps, where some other framework is responsible for consuming and displaying the response.
...
As we'll learn later, this can be useful for [displaying tool calls](../tool-calling/displays.qmd) in something like a [chatbot](chatbot-apps.qmd) app.
