...
4. [**Classification**](../structured-data/text-classification.qmd): Classify text into predefined categories, such as spam detection or topic classification.
5. [**Image/PDF input**](../structured-data/images.qmd): Extract data from images or PDFs, such as tables or forms, to automate data entry processes.


## Basic usage

To extract data, provide some input and a [pydantic model](https://docs.pydantic.dev/latest/concepts/models/) to [the `.extract_data()` method](../reference/Chat.qmd#extract_data).
