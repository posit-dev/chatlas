...
Great place to start is building a chatbot with a custom prompt. Chatbots are familiar interface and easy to create via [web application](web-apps.qmd) framework like Shiny or Streamlit.
