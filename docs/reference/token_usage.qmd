...
|--------|--------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
|        | [list](`list`)\[[TokenUsage](`chatlas.types.TokenUsage`)\] \| None | A list of dictionaries with the following keys: "name", "input", and "output". If no tokens have been logged, then None is returned. |