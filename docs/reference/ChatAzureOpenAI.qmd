...
| seed          | [int](`int`) \| None \| [MISSING_TYPE](`chatlas.types.MISSING_TYPE`)            | Optional integer seed that ChatGPT uses to try and make output more reproducible.                                                                                                                                                                                                                                                                                                                                         | `MISSING`  |
| kwargs        | [Optional](`typing.Optional`)\[\'AzureProviderArgs\'\]                          | Additional arguments to pass to the `openai.AzureOpenAI()` client constructor.                                                                                                                                                                                                                                                                                                                                            | `None`     |
