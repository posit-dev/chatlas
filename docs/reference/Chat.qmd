...
| kwargs         | [Optional](`typing.Optional`)\[[ChatRequestArgsT](`chatlas._chat.ChatRequestArgsT`)\] | Additional keyword arguments to pass to the method used for requesting the response. | `None`    |
