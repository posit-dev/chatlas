...
| kwargs         | [Optional](`typing.Optional`)\[[SubmitInputArgsT](`chatlas.types.SubmitInputArgsT`)\] | Additional keyword arguments to pass to the method used for requesting the response. | `None`    |
