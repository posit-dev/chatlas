...
<img src="/logos/hero/hero.png" height="325" alt="chatlas website banner image" class="d-block mx-auto mb-3"/>
...
Explore the world of LLMs in Python and build agentic chat apps — effortlessly.
</p>
...
🚀 **Minimal design**: most problems just need the right [model](get-started/models.qmd), [system prompt](get-started/system-prompt.qmd), and [tool calls](get-started/tools.qmd). Spend more time getting these right and less time untangling needless complexity.

🧩 [**Model agnostic**](get-started/models.qmd): try different models with minimal code changes.

🌊 [**Stream output**](get-started/chat.qmd): with minimal effort in notebooks, at the console, and your favorite IDE. You can also [stream](get-started/stream.qmd) responses into any environment (e.g., [chatbots](get-started/chatbots.qmd)).
...
🛠️ [**Tool calling**](get-started/tools.qmd): easily equip the LLM with the ability to gain the context they need and/or perform actions on behalf of the user.
...
✏️ [**Autocomplete**](get-started/parameters.qmd): powered by type hints, so you can easily discover and use provider-specific parameters like `temperature`, `max_tokens`, and more.

🔍 **Inspectable**: tools for [debugging](get-started/debug.qmd) and [monitoring](get-started/monitor.qmd) in production.

🔌 **Extensible**: add new [model providers](reference/Provider.qmd), [content types](), and more.
