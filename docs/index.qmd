...
🚀 **Minimal design**: most problems just need the right [model](get-started/models.qmd), [system prompt](get-started/system-prompt.qmd), and [tool calls](get-started/tools.qmd). Spend more time mastering the fundamentals and less time navigating needless complexity.
